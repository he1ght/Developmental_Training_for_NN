...
for checkpoint_name in name_list:
    ...
    for _seed in range(1, args.seeds + 1):
        try:
            ...
            seed_train_result = train(model, name=checkpoint_seed_name)
            seed_result = test(model, name=checkpoint_seed_name)
            # result.append([test_nll, test_te1, test_te3, test_te5])
            # print(seed_result)
