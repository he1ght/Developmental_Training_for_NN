...
def train_opts(parser):
    ...
    group = parser.add_argument_group('SKD')
    # Options most relevant to speech
    group.add('--skd', '-skd', action='store_true',
              help="Self-Knowledge Distillation.")
    group.add('--teacher', '-teacher', default='', type=str,
              help="Teacher Model for SKD.")
    group.add('--kd_a', '-kd_a', default=0.1, type=float,
